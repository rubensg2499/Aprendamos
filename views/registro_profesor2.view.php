                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="m-4">
                                    ...
                                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" ,
                                        ...
                                        <div class="form-group">
                                            <div class="form-label-group">
                                                <input type="text" name="nick" class="form-control"
                                                    placeholder="Usuario" minlength="5" maxlength="16" required value="<?php echo isset($_POST['nick']) ? $_POST['nick'] : '';?>">
                                        ...
                                        <div class="form-group">
                                            <div class="form-label-group">
                                                <input minlength="8" maxlength="16" type="password" name="inputPassword" class="form-control"
                                        ...
                                        <div class="text-right">
                                            ...
                                            <a href="registro_profesor1.php" class="btn btn-success "> Regresar </a>
