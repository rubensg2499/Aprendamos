...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  if(isset($_POST['submit'])){
    ...
    if($_POST['pregunta'] != 0){
      ...
      $pregunta = utf8_decode(filter_var($_POST['pregunta'], FILTER_SANITIZE_STRING));
      $respuesta = utf8_decode(filter_var($_POST['respuesta'], FILTER_SANITIZE_STRING));
      echo $usuario;
          ...
          if($resultado2 != false){
            ...
            if($pregunta == $resultado2['pregunta_seguridad']){
              ...
              if($respuesta == $resultado2['respuesta_pregunta']){
                $banderaMsg = enviar_correo($resultado2['correo'], $resultado2['nombre'], 
                                            $resultado2['nick_usuario'], $resultado2['pass']);
              }else{
