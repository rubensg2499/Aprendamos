<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $nick = $_SESSION['nick'];
        $pass = utf8_decode(filter_var($_SESSION['inputPassword'],FILTER_SANITIZE_STRING));
        $nombre = utf8_decode(filter_var($_SESSION['nombre'],FILTER_SANITIZE_STRING));
        $ape_pat = utf8_decode(filter_var($_SESSION['ape_pat'],FILTER_SANITIZE_STRING));
        $ape_mat = utf8_decode(filter_var($_SESSION['ape_mat'],FILTER_SANITIZE_STRING));
        $correo = utf8_decode(filter_var($_SESSION['correo'],FILTER_SANITIZE_STRING));
        $fecha_nac = utf8_decode(filter_var($_SESSION['fech_nac'],FILTER_SANITIZE_STRING));
        $escuela = utf8_decode(filter_var($_SESSION['esc_proc'],FILTER_SANITIZE_STRING));
        $grupo = utf8_decode(filter_var($_SESSION['grupo'],FILTER_SANITIZE_STRING));
        $grupo = (string)$grupo;
        $matricula = utf8_decode(filter_var($_SESSION['matricula'],FILTER_SANITIZE_STRING));
        $pregunta =  utf8_decode(filter_var($_SESSION['pregunta'],FILTER_SANITIZE_STRING));
        $respuesta = utf8_decode(filter_var($_SESSION['respuesta'],FILTER_SANITIZE_STRING));
        $resultado = false;
