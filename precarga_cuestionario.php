...
if (isset($_SESSION['usuario'])) {
    ...
    $nombre = filter_var($_POST['nombre_cuestionario'], FILTER_SANITIZE_STRING);
    ...
    $complejidad = filter_var($_SESSION['complejidad_cuestionario'], FILTER_SANITIZE_STRING);
    ...
    $_SESSION['id_cuest']=$reg['id_cuestionario'];
